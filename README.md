...
How to run: Upload the heart.csv file to sample_data/ in Colab or adjust path. Execute cells sequentially. Modify hyperparameters in max_depth_list to experiment further.
